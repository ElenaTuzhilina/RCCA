...
```{r, fig.height = 2.8, fig.width = 3.7, fig.align='center'}
...
Compare heatmaps.  
```{r, fig.height = 3.2, fig.width = 7.4, fig.align='center'}
for(df in dfs){
