...
The main hyperparameter for the PCMS and PoisMS approaches is the spline degrees-of-freedom $\operatorname{df}$ controlling the reconstruction smoothness. 
...
Compare heatmaps.  
```{r, fig.height = 2.3, fig.width = 5.7, fig.align='center'}
for(df in dfs){
...
Compare projections.   
```{r, fig.width = 5, fig.height = 13, fig.align='center'}
library(ggplot2)
